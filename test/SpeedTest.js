...
let harcon = new Harcon( {
	...
	blower: { commTimeout: 20000, tolerates: [ 'Marie.echo', 'Claire.extend' ] },
	mortar: { enabled: false, folder: path.join( __dirname, 'entities' ), liveReload: true, liveReloadTimeout: 2000 }
} )
...
async function comm () {
	...
	for (let i = 0; i < 10000; ++i)
		ps.push( inflicter.simpleRequest( 'Marie.echo', [
